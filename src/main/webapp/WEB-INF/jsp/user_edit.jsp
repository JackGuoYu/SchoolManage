		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;用户名：<input name="username" type="text" class="input3" value="${user.username}"/>
					</div>
					<div class="bbD">
						年龄：<input name="age" type="text" class="input3"  value="${user.age}"/>
					</div>
					<div class="bbD">
						电话：<input name="phone" type="text" class="input3" value="${user.phone}"/>
					</div>
					<div class="bbD">
						性别：
					...
					<div class="bbD">
						地址：<input name="adress" type="text" class="input3" value="${user.adress}"/>
					</div>
					<div class="bbD">
						<p class="bbDP">
